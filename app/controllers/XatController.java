 ...
 * A simple xat
 */
public class XatController extends Controller {

    private final Flow<String, String, NotUsed> userFlow;
    private final WebJarsUtil webJarsUtil;

    @Inject
    public XatController(ActorSystem actorSystem,
                         Materializer mat,
    ...
    public Result index(Http.Request request) {
        String url = routes.XatController.chat().webSocketURL(request);
        return Results.ok(views.html.xat.render(url, webJarsUtil));
    }
